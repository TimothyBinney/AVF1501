...
//@interface BinneyTimothy_Week2AVFObject : NSObject
//@end

@interface BinneyTimothy_Week2AVFObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[BinneyTimothy_Week2AVFObject class]])
		{
			for (NSString *key in [[(BinneyTimothy_Week2AVFObject*)o modules] allKeys])
			{
