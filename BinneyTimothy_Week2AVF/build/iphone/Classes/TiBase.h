...
// in simulator we redefine to format for BinneyTimothy_Week2AVF Developer console
...
{\
	NSString * exceptionName = [@"org.binneytimothy_week2avf." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.binneytimothy_week2avf";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIBinneyTimothy_Week2AVFNativeItemNone = -1, 
	UIBinneyTimothy_Week2AVFNativeItemSpinner = -2,
	UIBinneyTimothy_Week2AVFNativeItemProgressBar = -3,
	
	UIBinneyTimothy_Week2AVFNativeItemSlider = -4,
	UIBinneyTimothy_Week2AVFNativeItemSwitch = -5,
	UIBinneyTimothy_Week2AVFNativeItemMultiButton = -6,
	UIBinneyTimothy_Week2AVFNativeItemSegmented = -7,
	
	UIBinneyTimothy_Week2AVFNativeItemTextView = -8,
	UIBinneyTimothy_Week2AVFNativeItemTextField = -9,
	UIBinneyTimothy_Week2AVFNativeItemSearchBar = -10,
	
	UIBinneyTimothy_Week2AVFNativeItemPicker = -11,
	UIBinneyTimothy_Week2AVFNativeItemDatePicker = -12,
	
	UIBinneyTimothy_Week2AVFNativeItemInfoLight = -13,
	UIBinneyTimothy_Week2AVFNativeItemInfoDark = -14,
	
	UIBinneyTimothy_Week2AVFNativeItemDisclosure = -15,
	
	UIBinneyTimothy_Week2AVFNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all BinneyTimothy_Week2AVF instances of
