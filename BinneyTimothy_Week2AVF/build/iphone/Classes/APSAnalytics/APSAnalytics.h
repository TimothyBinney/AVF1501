 ...
 * to send analytic data that can be viewed on the BinneyTimothy_Week2AVF Dashboard.
 *
 * For information on getting started with BinneyTimothy_Week2AVF Platform Services,
