...
/**
 Base class for all BinneyTimothy_Week2AVF views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the BinneyTimothy_Week2AVF view hierarchy (such as wrapped iOS UIViews) was touched.
