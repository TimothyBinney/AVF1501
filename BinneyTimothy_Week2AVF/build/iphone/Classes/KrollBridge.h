...
@interface BinneyTimothy_Week2AVFObject : KrollCoverageObject {
#else
@interface BinneyTimothy_Week2AVFObject : KrollObject {
#endif
@private
...
extern NSString * BinneyTimothy_Week2AVF$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	BinneyTimothy_Week2AVFObject *_binneytimothy_week2avf;
    KrollObject* console;
	BOOL shutdown;
